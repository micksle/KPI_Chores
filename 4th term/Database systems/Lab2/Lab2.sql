...
PRIMARY KEY (ID),
#CONSTRAINT SalaryRouteCONST FOREIGN KEY (DriversSalary) REFERENCES route(ID), #Payment
CONSTRAINT PaymentRouteCONST FOREIGN KEY (Route) REFERENCES route(ID),  #Path
CONSTRAINT DriverExperienceCONST FOREIGN KEY (Experience) REFERENCES driver(ID)  #Experience
);

CREATE TABLE costOfTrasnportation (
ID INT NOT NULL AUTO_INCREMENT,
TrasnportationCost DECIMAL(8,2) NOT NULL,
DriversSalary INT NOT NULL,

PRIMARY KEY (ID),
CONSTRAINT salaryCONST FOREIGN KEY (DriversSalary) REFERENCES salary(ID)
);
...
INSERT INTO salary (Route, DriversSalary, Experience, SecondDriver) VALUES
(1, 1090.30, 1, false),
(2, 1340.0, 2, false),
(3, 2080.30, 3, true),
(4, 1120.90, 4, false),
...
(2, 2, current_timestamp(), '2023-04-18 14:22:53'),
(4, 3, current_timestamp(), '2023-04-16 19:05:23'),
(5, 6, '2023-03-15 13:17:17', '2023-03-16 8:07:03'),
(9, 5, '2023-03-13 13:11:02', '2023-03-13 23:15:23'),
(11, 7, current_timestamp(), '2023-04-16 19:05:23'),
...
(8, 8, current_timestamp(), '2023-04-18 14:22:53', 3.6);
...
INSERT INTO costOfTrasnportation (TrasnportationCost, DriversSalary) VALUES
(1240.9, 1),
(1308.10, 1),
(1490.8, 3);
